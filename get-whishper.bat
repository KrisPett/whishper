...
curl -o docker-compose.yml https://raw.githubusercontent.com/KrisPett/whishper/main/docker-compose.yml
...
if exist .env (
  ...
  if /i "%answer%"=="Y" (
    ...
    curl -o .env https://raw.githubusercontent.com/KrisPett/whishper/main/example.env
  ) else (
